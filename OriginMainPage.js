...
const OriginMainPage = ({navigation}) => {
  return (
    ...
    <View className="flex-row items-center mb-6">
      ...
      <TouchableOpacity onPress={() => navigation.navigate('AdventureGame')} className="bg-[#00FFD1] rounded-full px-4 py-2">
    ...
    <View className="flex-row items-center">
      ...
      <TouchableOpacity onPress={() => navigation.navigate('ZooManagement') } className="bg-[#00FFD1] rounded-full px-4 py-2">
        <Text className="text-black">Learn more</Text>
      </TouchableOpacity>
    </View>
  </SafeAreaView>
