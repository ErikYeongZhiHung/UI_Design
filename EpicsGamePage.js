...
const EpicsGamePage = ({navigation}) => {
  return (
    ...
    <View className="flex-row justify-between items-center mb-8 mt-4">
      ...
      <Text className="text-white text-lg">Epic Game</Text>
      <View style={{ width: 60 }} />
    </View>
    ...
    <View className="flex-row items-center mb-6">
      ...
      <TouchableOpacity onPress={() => navigation.navigate('EpicShotting')} className="bg-[#00FFD1] rounded-full px-4 py-2">
    ...
    <View className="flex-row items-center">
      ...
      <TouchableOpacity onPress={() => navigation.navigate('FootballManagementEpic',{title:'Epic Games'}) } className="bg-[#00FFD1] rounded-full px-4 py-2">
        <Text className="text-black">Learn more</Text>
      </TouchableOpacity>
    </View>
  </SafeAreaView>
