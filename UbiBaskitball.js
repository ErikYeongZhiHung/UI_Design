...
const UbiBaskitball = ({navigation}) => {
  return (
    ...
    <View className="flex-row  mb-6 mt-10">
      ...
      <View className="flex-1">
        ...
        <Text className="text-white text-xs ">• With the introduction of ProPLAY technology, unlike previous versions that relied on motion capture to replicate player actions, ProPLAY takes actual NBA footage and translates it into gameplay</Text>
